...
export function Sidebar({ version, installedAt }: SidebarProps) {
  ...
  return (
    <>
      {/* Desktop sidebar */}
      <aside className="hidden md:flex w-56 shrink-0 bg-white border-r border-gray-100 flex-col h-screen sticky top-0 overflow-y-auto">
        <div className="px-5 py-5 border-b border-gray-100">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <p className="text-sm font-semibold text-gray-900 leading-tight">Hausmanager</p>
              <p className="text-xs text-gray-400">Schweiz</p>
            </div>
          </div>
        </div>
